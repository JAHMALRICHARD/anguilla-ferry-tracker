...
export const SecurityModal: React.FC<SecurityModalProps> = ({ onClose }) => {
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center px-4">
      <div className="bg-background text-foreground max-w-2xl w-full rounded-2xl shadow-2xl p-8 relative border border-border font-sans">
        {/* Close Button */}
        <button
          onClick={onClose}
        ...
        <div className="space-y-10 text-sm sm:text-base text-muted-foreground leading-relaxed">
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-2 pl-1">
              ...
              <li>
                <span className="text-white font-medium">Personal Safety:</span>{" "}
